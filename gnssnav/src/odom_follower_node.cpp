#include "gnssnav/odom_follower_node.hpp"
...
: rclcpp::Node("gnssnav_follower_node", name_space, options)
{
    ...
    odom_sub_ = this->create_subscription<nav_msgs::msg::Odometry>("/odom", 10, std::bind(&Follower::vectornavCallback, this, std::placeholders::_1));
...
void Follower::vectornavCallback(const nav_msgs::msg::Odometry::SharedPtr msg) {
