#include "vectormap_control/plugins/pure_pursuit_plugin.hpp"
...
PLUGINLIB_EXPORT_CLASS(vectormap_control::PurePursuitPlugin, vectormap_control::ControllerPlugin)
