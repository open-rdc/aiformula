  ...
  qos_(rclcpp::QoS(10))
{
    ...
    pose_subscription_ = create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>("/localization/pose", qos_, std::bind(&LocalPlannerServer::pose_callback, this, std::placeholders::_1));
