#ifndef PATH_TRACKER__MPC_NODE_SIM_HPP_
#define PATH_TRACKER__MPC_NODE_SIM_HPP_
...
#include <nav_msgs/msg/odometry.hpp> // Added for Simulator
...
class MPCNodeSim : public rclcpp::Node {
public:
  explicit MPCNodeSim(const rclcpp::NodeOptions &options);
...
#endif // PATH_TRACKER__MPC_NODE_SIM_HPP_
